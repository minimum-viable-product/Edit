...
void create_bars(void)
{
    ...
    if (g_menubar.items != NULL) {
        ...
        g_menubar.items[0].col.length = 6;
        ...
        g_menubar.items[1].col.length = 6;
        ...
        g_menubar.items[2].col.length = 8;
        ...
        g_menubar.items[3].col.length = 6;
        ...
        g_menubar.items[4].col.length = 9;
        ...
        g_menubar.items[5].col.length = 6;
    ...
    if (g_statusbar.items != NULL) {
        ...
        g_statusbar.items[0].col.length = 9;
